...
def buildTrackUrl(trackId):
	return "https://open.spotify.com/track/%s" % trackId
...
def getRecommendations(spotify, genres, seedList):
	return spotify.recommendations(seed_genres=genres, seed_tracks=seedList, limit=20, min_duration_ms=60000, max_speechiness=0.70, max_liveness=0.75)